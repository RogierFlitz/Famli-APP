  ...
  return (
    <div className="relative mt-12 lg:mt-0">
      <div className="famli-card rounded-[2rem] p-5 shadow-[var(--famli-shadow-lift)]">
        ...
        <p className="mt-1 text-sm text-[color:var(--famli-muted)]">Vandaag bij papa · wissel om 17:00</p>
        <div className="mt-5 space-y-3">
          <div className="rounded-2xl bg-[color:var(--famli-parent-1)]/35 p-4">
            ...
            <p className="mt-1 font-medium">Kinderen naar papa</p>
